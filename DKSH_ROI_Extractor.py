...
def dksh_extract_roi_product(image, coord_quantity, coord_product, image_height, text_height_multiplier=6):
...
def dksh_extract_roi_quantity(image, coord_quantity, coord_price, text_height_multiplier=6):
...
def dksh_extract_roi_batch_num(image, coord_batch_num, text_height_multiplier=6):
...
def dksh_extract_roi_date(image, coord_batch_num, coord_expiry, text_height_multiplier=6):
